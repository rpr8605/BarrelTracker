...
const nav: Array<{ href: string; label: string; icon: string; alertKey?: boolean; tour?: string }> = [
  ...
  { href: '/production-chain', label: 'Production Chain', icon: '⟿' },
  { href: '/npd-lab', label: 'NPD Lab', icon: '🧪' },
  { href: '/blend-bench', label: 'Blend Bench', icon: '⚗' },
  { href: '/economics', label: 'Bottle Economics', icon: '$' },
  { href: '/compliance/audit', label: 'Audit Readiness', icon: '🔍' },
  { href: '/releases', label: 'Release Planner', icon: '🚀' },
  { href: '/snapshot', label: 'Owner Snapshot', icon: '📊' },
  { href: '/consultant', label: 'Consultant Portal', icon: '🤝' },
