...
- Name: auth.spec.ts >> Demo mode >> enters demo with any name
- Location: tests\auth.spec.ts:84:7
...
Call log:
  - Expect "toHaveURL" with timeout 30000ms
    7 × unexpected value "https://barrel-tracker.vercel.app/login"
    26 × unexpected value "https://barrel-tracker.vercel.app/onboarding"
